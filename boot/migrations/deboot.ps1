...
try {
    ...
    winget uninstall --id=Oven-sh.Bun -e --accept-source-agreements --silent
...
try {
    ...
    winget uninstall --id=Microsoft.OpenSSH.Preview -e --accept-source-agreements --silent
...
try {
    ...
    winget uninstall --id=GnuWin32.Which -e --accept-source-agreements --silent
